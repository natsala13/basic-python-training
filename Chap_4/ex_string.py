...
def donuts(count):
    if count < 10:
        donuts_num = 'Number of donuts: ' + str(count)
    else:
        donuts_num = 'Number of donuts: many'
    return donuts_num
...
def not_bad(s):
    ...
    bad_1 = s.find('bad')
    if bad_1 > not_1 :
        s = s[0:not_1] + 'good'+ s[bad_1+3:len(s)]
